      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <section className="py-12 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Understanding SWP — Systematic Withdrawal Plan</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-5">
                <h4 className="font-semibold text-slate-900 mb-2">Step 1: Invest Corpus</h4>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-5">
                <h4 className="font-semibold text-slate-900 mb-2">Step 2: Set SWP Amount</h4>
                <p className="text-slate-600 text-sm">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-5">
                <h4 className="font-semibold text-slate-900 mb-2">Step 3: Remaining Grows</h4>
                <p className="text-slate-600 text-sm">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-5">
                <h4 className="font-semibold text-slate-900 mb-2">Step 4: Receive Withdrawals</h4>
                <p className="text-slate-600 text-sm">
            ...
            {/* SWP Tax Efficiency */}
            <h2 className="text-2xl font-bold text-slate-900 mb-4">SWP Tax Efficiency — Why It Beats FD Interest</h2>
            <p className="text-slate-600 mb-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              <div className="bg-green-50 border border-green-100 p-5 rounded-xl">
                ...
                <div className="text-sm font-semibold text-slate-700 mb-2">Oldest units redeemed first</div>
                <p className="text-sm text-slate-600">Under FIFO (First In First Out), the oldest units held 1+ years are redeemed first, making them eligible for LTCG tax exemption (if held 1+ year). Early withdrawals are often LTCG-free.</p>
              </div>
              <div className="bg-blue-50 border border-blue-100 p-5 rounded-xl">
                <div className="text-2xl font-bold text-blue-700 mb-1">Equity SWP</div>
                <div className="text-sm font-semibold text-slate-700 mb-2">LTCG: 10% above ₹1L</div>
                <p className="text-sm text-slate-600">Equity funds held 1+ year: LTCG tax only 10% above ₹1L exemption limit. Example: ₹3L gains taxed only on ₹2L = ₹20,000 tax. Very tax-efficient.</p>
              </div>
              <div className="bg-orange-50 border border-orange-100 p-5 rounded-xl">
                ...
                <div className="text-sm font-semibold text-slate-700 mb-2">100% slab rate tax</div>
                <p className="text-sm text-slate-600">FD interest is fully taxable at your slab rate (20-30%). Same ₹3L interest taxed at 30% = ₹90,000 tax. SWP saves ₹70,000 in taxes!</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-slate-50 border rounded-xl p-6">
                <h3 className="font-bold text-slate-900 mb-3">Example 1 — ₹1 Cr Corpus, ₹40,000/Month SWP</h3>
              ...
              <div className="bg-slate-50 border rounded-xl p-6">
                <h3 className="font-bold text-slate-900 mb-3">Example 2 — ₹50L Corpus, ₹25,000/Month SWP</h3>
                <div className="space-y-1 text-sm text-slate-700">
            ...
            {/* Pro Tips */}
            <h2 className="text-2xl font-bold text-slate-900 mb-4">Pro Tips on SWP — Make Your Retirement Last</h2>
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                ...
                <div>
                  <p className="font-semibold text-slate-900 text-sm">Follow the 4% rule — don't withdraw more than 4-5% annually</p>
                  <p className="text-slate-600 text-sm mt-1">On ₹1 Cr corpus, limit withdrawals to ₹40,000-50,000/month. Withdrawing 8%+ depletes corpus in 10-12 years. Use our calculator to test sustainability before committing to SWP amount.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">2</span>
                <div>
                  <p className="font-semibold text-slate-900 text-sm">Use equity funds for SWP, not debt — LTCG far lower than FD tax</p>
                  <p className="text-slate-600 text-sm mt-1">Equity SWP: LTCG 10% above ₹1L limit. Debt/FD interest: fully taxed at 20-30% slab. Equity SWP saves ₹60,000-80,000 annual tax on ₹50L corpus vs FD. Triple tax-efficient.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">3</span>
                <div>
                  <p className="font-semibold text-slate-900 text-sm">Keep 2 years of expenses in liquid fund as buffer — don't touch equity SWP during crash</p>
                  <p className="text-slate-600 text-sm mt-1">During market downturns, SWP redeems more units to meet fixed withdrawal. Liquid buffer protects you from forced selling at market lows. Keep ₹4-5L liquid, take rest from SWP equity fund.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">4</span>
                <div>
                  <p className="font-semibold text-slate-900 text-sm">Inflation-adjust your SWP every 3 years — increase withdrawal by 6-7%</p>
                  <p className="text-slate-600 text-sm mt-1">Start SWP at ₹40,000/month. In 3 years, increase to ₹47,600 (19% increase). Your purchasing power stays intact. Most fund houses allow online adjustments via portal or app.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">5</span>
                <div>
                  <p className="font-semibold text-slate-900 text-sm">FIFO means older units redeemed first — most early redemptions are LTCG-exempt</p>
                  <p className="text-slate-600 text-sm mt-1">Under FIFO (fund house default), oldest units held 1+ year are redeemed. If you invested 3 years ago, first 3 years of SWP have zero tax! Capital comes out tax-free, only recent gains are taxed.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">6</span>
                <div>
                  <p className="font-semibold text-slate-900 text-sm">Combine SWP + NPS pension + EPF for diversified retirement income streams</p>
                  <p className="text-slate-600 text-sm mt-1">Don't rely on SWP alone. Layer it: NPS annuity (₹15-20K/month) + SWP (₹40K/month) + EPF (₹25K/month) = ₹80K monthly income from multiple sources. Reduces concentration risk.</p>
                </div>
              </div>
            </div>

            {/* SWP vs FD vs Dividend Comparison */}
            <h2 className="text-2xl font-bold text-slate-900 mb-4">SWP vs FD vs Dividend — Retirement Income Comparison</h2>
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr>
                    <td className="border border-slate-200 p-3 text-slate-700">Expected Return</td>
                    <td className="border border-slate-200 p-3 text-center font-semibold">8-10% p.a.</td>
                    <td className="border border-slate-200 p-3 text-center">6-7% p.a.</td>
                    <td className="border border-slate-200 p-3 text-center">2-4% p.a.</td>
                  </tr>
                  <tr className="bg-slate-50">
                    <td className="border border-slate-200 p-3 text-slate-700">Tax Treatment</td>
                    <td className="border border-slate-200 p-3 text-center">LTCG 10% (equity)</td>
                    <td className="border border-slate-200 p-3 text-center">Slab rate (20-30%)</td>
                    <td className="border border-slate-200 p-3 text-center">DDT / LTCG / Slab</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3 text-slate-700">Post-Tax Income on ₹50L</td>
                    <td className="border border-slate-200 p-3 text-center font-bold text-green-700">~₹36-38K/mo</td>
                    <td className="border border-slate-200 p-3 text-center">~₹26-28K/mo</td>
                    <td className="border border-slate-200 p-3 text-center">~₹8-12K/mo</td>
                  </tr>
                  <tr className="bg-slate-50">
                    <td className="border border-slate-200 p-3 text-slate-700">Predictability</td>
                    <td className="border border-slate-200 p-3 text-center">High (fixed amount)</td>
                    <td className="border border-slate-200 p-3 text-center">Very High</td>
                    <td className="border border-slate-200 p-3 text-center">Low (uncertain)</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3 text-slate-700">Remaining Corpus Growth</td>
                    <td className="border border-slate-200 p-3 text-center font-semibold text-blue-700">Yes, keeps growing</td>
                    <td className="border border-slate-200 p-3 text-center">Yes, modest</td>
                    <td className="border border-slate-200 p-3 text-center">Yes, strong</td>
                  </tr>
                  <tr className="bg-slate-50">
                    <td className="border border-slate-200 p-3 text-slate-700">Flexibility</td>
                    <td className="border border-slate-200 p-3 text-center font-semibold">Fully flexible</td>
                    <td className="border border-slate-200 p-3 text-center">No early exit</td>
                    <td className="border border-slate-200 p-3 text-center">Flexible</td>
                  </tr>
                  <tr>
                    <td className="border border-slate-200 p-3 text-slate-700">Ideal For</td>
                    <td className="border border-slate-200 p-3 text-center">Retirees, 20+ yrs</td>
                    <td className="border border-slate-200 p-3 text-center">Safety-first, short-term</td>
                    <td className="border border-slate-200 p-3 text-center">Growth + income mix</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Link href="/calculators/sip">
                <div className="p-4 bg-white rounded-lg border hover:border-blue-300 hover:shadow transition-all">
                  ...
                  <p className="text-sm text-slate-600">Build retirement corpus through systematic monthly investing</p>
                </div>
              </Link>
              ...
              <Link href="/calculators/pf">
                <div className="p-4 bg-white rounded-lg border hover:border-green-300 hover:shadow transition-all">
                  ...
                  <p className="text-sm text-slate-600">Add EPF + VPF growth to your retirement planning</p>
                </div>
              </Link>
