      ...
      <div className="bg-card">
        ...
        <section className="py-12 px-6 bg-card">
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-ink mb-6">Understanding NPS — National Pension System</h2>

            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-ink mb-3">What is NPS?</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-ink mb-3">Who Should Use NPS?</h3>
                <p className="text-ink/65">
            ...
            <h2 className="text-2xl font-bold text-ink mb-4">NPS Tax Benefits — All 3 Sections Explained</h2>
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              <div className="bg-secondary border border-rule p-5 rounded-xl">
                <div className="text-2xl font-bold text-ink mb-1">80CCD(1)</div>
                <div className="text-sm font-semibold text-ink/80 mb-2">Your own contribution</div>
                <p className="text-sm text-ink/65">Up to 10% of salary (basic+DA) or 20% of gross income for self-employed. This falls <em>within</em> the overall ₹1.5L Section 80C limit.</p>
              </div>
              <div className="bg-green-50 border border-green-100 p-5 rounded-xl">
                ...
                <div className="text-sm font-semibold text-ink/80 mb-2">Extra ₹50,000 deduction</div>
                <p className="text-sm text-ink/65"><strong>Over and above the ₹1.5L 80C limit.</strong> Any Indian resident can claim this. At 30% slab = ₹15,000 tax saved every year. Don't miss this.</p>
              </div>
              <div className="bg-paper border border-rule p-5 rounded-xl">
                <div className="text-2xl font-bold text-ink mb-1">80CCD(2)</div>
                <div className="text-sm font-semibold text-ink/80 mb-2">Employer's contribution</div>
                <p className="text-sm text-ink/65">Up to 10% of salary for private sector (14% for govt). <strong>No upper limit in rupee terms.</strong> Fully deductible and not part of 80C.</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-secondary border rounded-xl p-6">
                <h3 className="font-bold text-ink mb-3">Example 1 — Salaried at 30% Slab</h3>
                <div className="space-y-1 text-sm text-ink/80">
                  ...
                  <div className="flex justify-between"><span>Total Corpus at 60:</span><span className="font-bold text-ink">~₹2.28 Cr</span></div>
                  ...
                  <div className="flex justify-between"><span>Monthly Pension (est.):</span><span className="font-bold text-ink">~₹45,600/mo</span></div>
                  <div className="flex justify-between"><span>Annual Tax Saving:</span><span className="font-bold text-orange-700">~₹60,000+</span></div>
                </div>
              </div>

              <div className="bg-secondary border rounded-xl p-6">
                <h3 className="font-bold text-ink mb-3">Example 2 — Self-Employed CA at 30% Slab</h3>
                <div className="space-y-1 text-sm text-ink/80">
                  ...
                  <div className="border-t border-rule my-2"></div>
                  <div className="flex justify-between"><span>Total Corpus at 60:</span><span className="font-bold text-ink">~₹1.33 Cr</span></div>
                  <div className="flex justify-between"><span>Tax-Free Lump Sum (60%):</span><span className="font-bold text-green-700">~₹80 L</span></div>
                  <div className="flex justify-between"><span>Monthly Pension (est.):</span><span className="font-bold text-ink">~₹26,600/mo</span></div>
            ...
            {/* CA Tips */}
            <h2 className="text-2xl font-bold text-ink mb-4">CA Tips on NPS — Things Your Employer Won't Tell You</h2>
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                ...
                <div>
                  <p className="font-semibold text-ink text-sm">Always use 80CCD(1B) separately</p>
                  <p className="text-ink/65 text-sm mt-1">Even if you've maxed ₹1.5L under 80C, put ₹50,000 more in NPS Tier I. It's a standalone deduction. At 30% slab, that's ₹15,000 free tax saving every year.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">2</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Negotiate higher employer NPS contribution</p>
                  <p className="text-ink/65 text-sm mt-1">Ask HR to restructure CTC — move part of your salary to NPS employer contribution. It falls under 80CCD(2) with no upper cap and is fully exempt from tax.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">3</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Choose 'Active Choice' not 'Auto Choice'</p>
                  <p className="text-ink/65 text-sm mt-1">Under Active Choice, you can put up to 75% in equity (E fund). Young investors (under 40) should maximise equity allocation for higher long-term returns.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">4</span>
                <div>
                  <p className="font-semibold text-ink text-sm">NPS works under both tax regimes</p>
                  <p className="text-ink/65 text-sm mt-1">80CCD(1B) deduction is available under the old regime. Under the new regime, only 80CCD(2) (employer contribution) is deductible. Old regime wins for NPS deductions.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">5</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Annuity pension is fully taxable</p>
                  <p className="text-ink/65 text-sm mt-1">The monthly pension you receive post-retirement from the 40% annuity corpus is taxed as income. Plan your retirement income mix (EPF + NPS + other) to keep total income below taxable threshold.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">6</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Defer annuity up to age 75</p>
                  <p className="text-ink/65 text-sm mt-1">You don't have to buy annuity at 60. You can defer NPS maturity up to age 75, allowing the corpus to keep growing tax-deferred — a powerful strategy for those with other income sources post-60.</p>
                </div>
              </div>
            </div>

            {/* NPS vs PPF vs EPF Comparison */}
            <h2 className="text-2xl font-bold text-ink mb-4">NPS vs PPF vs EPF — Quick Comparison</h2>
            <div className="overflow-x-auto mb-8">
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-secondary">
                    <th className="border border-rule p-3 text-left font-semibold">Feature</th>
                    <th className="border border-rule p-3 text-center font-semibold text-ink">NPS</th>
                    <th className="border border-rule p-3 text-center font-semibold text-green-700">PPF</th>
                    <th className="border border-rule p-3 text-center font-semibold text-ink">EPF</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className="border border-rule p-3 text-center">₹1.5L</td>
                    <td className="border border-rule p-3 text-center">12% of basic</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 text-ink/80">Tax on Returns</td>
                    <td className="border border-rule p-3 text-center">Market-linked</td>
                  ...
                  <tr>
                    ...
                    <td className="border border-rule p-3 text-center">60% tax-free; 40% annuity taxable</td>
                    <td className="border border-rule p-3 text-center">Fully tax-free</td>
                    <td className="border border-rule p-3 text-center">Tax-free after 5 yrs</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 text-ink/80">Extra Deduction</td>
                    <td className="border border-rule p-3 text-center font-semibold text-green-700">+₹50,000 (80CCD1B)</td>
                    <td className="border border-rule p-3 text-center">Within ₹1.5L only</td>
                    <td className="border border-rule p-3 text-center">Within ₹1.5L only</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 text-ink/80">Expected Returns</td>
                    <td className="border border-rule p-3 text-center">9–12% (market-linked)</td>
                    <td className="border border-rule p-3 text-center">7.1% (fixed)</td>
                    <td className="border border-rule p-3 text-center">8.25% (FY25)</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 text-ink/80">Lock-in</td>
                    <td className="border border-rule p-3 text-center">Till age 60</td>
                    <td className="border border-rule p-3 text-center">15 years</td>
                    <td className="border border-rule p-3 text-center">Till retirement/exit</td>
                  </tr>
                </tbody>
              </table>
            ...
            <h2 className="text-2xl font-bold text-ink mb-2">NPS Corpus Projection Table — How Much Will You Accumulate? (at 10% p.a.)</h2>
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-ink text-white">
                    <th className="border border-ink p-3 text-left font-semibold">Monthly Contribution</th>
                    <th className="border border-ink p-3 text-center font-semibold">10 Years</th>
                    <th className="border border-ink p-3 text-center font-semibold">15 Years</th>
                    <th className="border border-ink p-3 text-center font-semibold">20 Years</th>
                    <th className="border border-ink p-3 text-center font-semibold">25 Years</th>
                    <th className="border border-ink p-3 text-center font-semibold">30 Years</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-rule p-3 font-semibold text-ink">₹2,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹4.13 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹8.36 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹15.31 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹26.76 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹45.59 L</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 font-semibold text-ink">₹5,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹10.33 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹20.90 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹38.28 L</td>
                    <td className="border border-rule p-3 text-center text-ink font-semibold">₹66.89 L</td>
                    <td className="border border-rule p-3 text-center text-ink font-semibold">₹1.14 Cr</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 font-semibold text-ink">₹10,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹20.66 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹41.79 L</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹76.57 L</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹1.34 Cr</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹2.28 Cr</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 font-semibold text-ink">₹20,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹41.31 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹83.58 L</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹1.53 Cr</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹2.68 Cr</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹4.56 Cr</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-3">
              <a href="https://enps.nsdl.com" target="_blank" rel="noopener noreferrer" className="block p-4 bg-card border border-rule rounded-lg hover:border-credit hover:shadow-md transition-all group">
                <div className="font-bold text-ink mb-1 group-hover:text-credit">eNPS (NSDL)</div>
                <p className="text-xs text-ink/65 mb-3">Official government NPS portal. Directly under PFRDA. Aadhaar-based KYC. Zero charges. Best for self-employed & unorganised sector.</p>
                <span className="text-xs bg-secondary text-ink px-2 py-1 rounded font-medium">Open Online →</span>
              </a>
              <a href="https://www.sbi.co.in/web/personal-banking/investments-and-insurance/nps" target="_blank" rel="noopener noreferrer" className="block p-4 bg-card border border-rule rounded-lg hover:border-blue-400 hover:shadow-md transition-all group">
                <div className="font-bold text-ink mb-1 group-hover:text-credit">SBI NPS</div>
                <p className="text-xs text-ink/65 mb-3">Open via SBI branch or YONO app. Preferred for SBI account holders — contributions auto-debited from savings account.</p>
                <span className="text-xs bg-blue-100 text-ink px-2 py-1 rounded font-medium">Open via SBI →</span>
              </a>
              <a href="https://www.hdfcbank.com/personal/save/accounts/nps" target="_blank" rel="noopener noreferrer" className="block p-4 bg-card border border-rule rounded-lg hover:border-red-400 hover:shadow-md transition-all group">
                <div className="font-bold text-ink mb-1 group-hover:text-red-700">HDFC Bank NPS</div>
                <p className="text-xs text-ink/65 mb-3">Open via HDFC NetBanking. Good for HDFC account holders wanting auto-debit integration with their existing accounts.</p>
                <span className="text-xs bg-red-100 text-red-700 px-2 py-1 rounded font-medium">Open via HDFC →</span>
              </a>
              <a href="https://zerodha.com/nps" target="_blank" rel="noopener noreferrer" className="block p-4 bg-card border border-rule rounded-lg hover:border-orange-400 hover:shadow-md transition-all group">
                <div className="font-bold text-ink mb-1 group-hover:text-orange-700">Zerodha NPS</div>
                <p className="text-xs text-ink/65 mb-3">Fully digital via Zerodha Coin. Best if you already invest in mutual funds via Zerodha — single dashboard for NPS + SIP.</p>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Link href="/calculators/pf">
                <div className="p-4 bg-card rounded-lg border hover:border-credit hover:shadow transition-all">
                  ...
                  <p className="text-sm text-ink/65">Calculate EPF + VPF corpus alongside your NPS</p>
                </div>
              </Link>
              <Link href="/calculators/income-tax">
                <div className="p-4 bg-card rounded-lg border hover:border-credit hover:shadow transition-all">
                  <h3 className="font-semibold text-ink mb-1">Income Tax Calculator</h3>
                  <p className="text-sm text-ink/65">See exact tax saving from NPS deductions</p>
                </div>
              </Link>
              <Link href="/calculators/sip">
                <div className="p-4 bg-card rounded-lg border hover:border-green-300 hover:shadow transition-all">
                  ...
                  <p className="text-sm text-ink/65">Build wealth outside NPS with mutual fund SIPs</p>
                </div>
              </Link>
