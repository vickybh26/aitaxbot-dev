...
export default function FindCA() {
  ...
  return (
    <>
      ...
      <div>
        {/* Hero */}
        <div className="bg-gradient-to-br from-ink via-credit to-credit text-white py-14 px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-card/20 px-4 py-1.5 rounded-full text-sm font-medium mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-9 bg-card text-ink h-11 border-0"
                />
              </div>
              <div className="relative">
                <select
                  ...
                  className="h-11 px-4 pr-8 rounded-md border-0 bg-card text-ink text-sm focus:outline-none focus:ring-2 focus:ring-white/50 appearance-none w-full sm:w-auto"
                >
        ...
        <div className="max-w-5xl mx-auto px-6 py-10">
          ...
          {!loading && !error && filtered.length === 0 && (
            <div className="text-center py-20">
              ...
              <Link href="/ca/register" className="inline-block mt-4 text-credit hover:underline text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {filtered.map((ca) => (
              <div
                key={ca.id}
                className="bg-card rounded-2xl border border-rule shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 p-5 flex flex-col"
              >
                {/* Avatar + name */}
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-11 h-11 rounded-full bg-paper0 flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
                    {ca.fullName.charAt(0)}
                  </div>
                  <div className="min-w-0">
                    <h3 className="font-semibold text-ink text-sm leading-tight truncate">{ca.fullName}</h3>
                ...
                {/* Bio */}
                {ca.bio && (
                  <p className="text-xs text-ink/65 mb-3 leading-relaxed line-clamp-2">{ca.bio}</p>
                )}
                ...
                <div className="flex flex-wrap gap-1 mb-3">
                  {ca.practiceAreas.slice(0, 4).map((area) => (
                    <span
                      key={area}
                      className="text-xs px-2 py-0.5 bg-secondary text-ink rounded-full"
                    >
                ...
                <div className="mt-auto flex gap-2">
                  <Button
                    size="sm"
                    className="flex-1 bg-ink hover:bg-credit text-white text-xs h-8"
          ...
          {!loading && (
            <div className="mt-12 bg-gradient-to-r from-blue-50 to-paper border border-rule rounded-2xl p-6 text-center">
              ...
              <Link href="/ca/register">
                <Button className="bg-ink hover:bg-credit text-white">
          ...
          <div id="disclaimer" className="mt-10 bg-card border border-rule rounded-2xl p-6 text-xs text-ink/55 leading-relaxed space-y-3">
            ...
            <p>
              <strong className="text-ink/65">Nature of service.</strong> AiTaxBot ("Platform") operates as an
            ...
            <p>
              <strong className="text-ink/65">No referral, recommendation, or endorsement.</strong> AiTaxBot
            ...
            <p>
              <strong className="text-ink/65">No fees charged.</strong> AiTaxBot does not charge any fee to
            ...
            <p>
              <strong className="text-ink/65">CA responds at their own discretion.</strong> Submission of an
            ...
            <p>
              <strong className="text-ink/65">Verify before engaging.</strong> Users are strongly advised to
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="underline text-credit"
              >
                ICAI Member Search
              </a>.
            </p>
            ...
            <p>
              <strong className="text-ink/65">CA responsibility for ICAI compliance.</strong> CAs listed on
            ...
            <p>
              <strong className="text-ink/65">Limitation of liability.</strong> AiTaxBot is not a party to
            ...
            <p>
              <strong className="text-ink/65">Data.</strong> Contact details submitted through the enquiry
              ...
              <Link href="/privacy-policy" className="underline text-credit">Privacy Policy</Link> for full details.
            </p>

            <p className="pt-1 border-t border-rule">
              For questions about this disclaimer, contact us at{" "}
              <a href="mailto:admin@aitaxbot.co.in" className="underline text-credit">
          ...
          <div className="mt-6 bg-green-50 border border-green-100 rounded-2xl p-6 text-xs text-ink/65 leading-relaxed">
            <h2 className="text-sm font-semibold text-ink/80 mb-1 flex items-center gap-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <strong className="text-ink/80">Clause 5, First Schedule Part I — No payment for securing professional business.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">Clause 6 Proviso (ii), First Schedule Part I — Response to organisation-issued enquiry.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">Clause 6 Item K — No roving circulars or cold outreach.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">§3.1.2(iii), Council Guidelines for Advertisement, 2008 — Directories are a permitted medium.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">§3.1.3(E) — No testimonials or endorsements.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">§3.1.3(F) — No awards, achievements, or positions.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">§3.4 — Online Third Party Platforms — contact details not displayed.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">§3.5 — Application-based Aggregators — non-exclusive services only.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">§3.6 — Specialised Directories — alphabetical listing.</strong>{" "}
              ...
              <div className="flex items-start gap-2.5">
                <CheckCircle className="w-3.5 h-3.5 text-green-600 flex-shrink-0 mt-0.5" />
                <div>
                  <strong className="text-ink/80">§3.3.14 — Website design must not amount to solicitation.</strong>{" "}
            ...
            {sent ? (
              ...
              <form onSubmit={sendContact} className="p-6 space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={sending}
                  className="w-full bg-ink hover:bg-credit text-white"
                >
                  {sending ? (
