    ...
    <>
      ...
      <div className="bg-card">
        ...
        <section className="py-6 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="border-l-4 border-amber-500 bg-secondary px-5 py-4 rounded-r-lg">
              <p className="text-xs font-semibold text-amber-600 uppercase tracking-wide mb-1">Tax Planning</p>
              <p className="text-sm font-semibold text-ink mb-1">Most SIP investors don't plan for LTCG tax — and it costs them.</p>
        ...
        <section className="py-12 px-6 bg-card">
          <div className="max-w-6xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-ink mb-6">Understanding SIP Investment</h2>

            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-ink mb-3">What is SIP?</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-ink mb-3">Who Should Invest in SIP?</h3>
                <p className="text-ink/65">
            ...
            <h2 className="text-2xl font-bold text-ink mb-4">How SIP Compounding Works</h2>
            <div className="bg-secondary border border-rule p-6 rounded-xl mb-8">
              <div className="font-mono text-ink font-semibold mb-3">
                FV = P × [((1 + r)^n - 1) / r] × (1 + r)
              </div>
            ...
            {/* Worked Examples */}
            <h2 className="text-2xl font-bold text-ink mb-4">SIP Growth Examples</h2>
            <div className="grid md:grid-cols-2 gap-6 mb-8">

              <div className="bg-secondary border rounded-xl p-6">
                <h3 className="font-bold text-ink mb-3">Example 1 — Regular SIP for 20 Years</h3>
                <div className="space-y-1 text-sm text-ink/80">
                  ...
                  <div className="flex justify-between"><span>Total Invested:</span><span className="font-bold text-ink">₹12,00,000</span></div>
                  <div className="flex justify-between"><span>Capital Gains:</span><span className="font-bold text-green-700">₹36,00,000</span></div>
                  <div className="flex justify-between"><span>Final Corpus:</span><span className="font-bold text-ink">₹48,00,000</span></div>
              ...
              <div className="bg-secondary border rounded-xl p-6">
                <h3 className="font-bold text-ink mb-3">Example 2 — Step-up SIP (10% Annual Increase)</h3>
                <div className="space-y-1 text-sm text-ink/80">
                  ...
                  <div className="flex justify-between"><span>Expected Return:</span><span className="font-semibold">12% p.a.</span></div>
                  <div className="border-t border-rule my-2"></div>
                  <div className="flex justify-between"><span>Total Invested:</span><span className="font-bold text-ink">₹12,34,000</span></div>
                  <div className="flex justify-between"><span>Capital Gains:</span><span className="font-bold text-green-700">₹25,66,000</span></div>
                  <div className="flex justify-between"><span>Final Corpus:</span><span className="font-bold text-ink">₹38,00,000</span></div>
            ...
            {/* Pro Tips */}
            <h2 className="text-2xl font-bold text-ink mb-4">Pro Tips on SIP — Maximize Your Wealth</h2>
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                ...
                <div>
                  <p className="font-semibold text-ink text-sm">Start SIP as early as possible</p>
                  <p className="text-ink/65 text-sm mt-1">₹500/month SIP started at age 25 grows to ₹1.5+ Cr by 60 at 12% returns. Start the same at 35 and you get only ₹38 lakh. Time is your biggest asset — even small amounts invested early beat large amounts invested late.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">2</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Never stop SIP during market downturns</p>
                  <p className="text-ink/65 text-sm mt-1">When market falls 20-30%, fund prices drop. Keep investing — you're buying units cheap! Market recoveries reward long-term investors. Those who stopped SIP in 2020 COVID crash missed 50%+ returns that followed.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">3</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Use step-up SIP with salary hikes</p>
                  <p className="text-ink/65 text-sm mt-1">Every time your salary increases, step-up your SIP by the same percentage. A ₹5,000 SIP stepped-up 10% annually becomes ₹12,900 by year 15 — without changing your lifestyle, you've multiplied your wealth creation speed.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">4</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Plan LTCG tax — spread redemptions across years</p>
                  <p className="text-ink/65 text-sm mt-1">Redeem ₹10-15 lakh per year to keep gains under ₹1.25L per financial year and pay zero LTCG tax. Redeem everything in one year and you could pay 12.5% tax on the full surplus (Finance Act 2024). Tax planning can save ₹1–5 lakh+ on a mature corpus.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">5</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Use index funds for core portfolio</p>
                  <p className="text-ink/65 text-sm mt-1">Index funds (Nifty 50, Sensex) have expense ratios of 0.1-0.3% vs 1-2% for active funds. Over 20 years, this 1.5% difference adds up to 20%+ extra wealth. Use 70% index funds for core, 30% active for alpha.</p>
                </div>
              </div>
              <div className="flex gap-3 p-4 bg-amber-50 border border-amber-100 rounded-lg">
                <span className="text-amber-600 text-lg font-bold shrink-0">6</span>
                <div>
                  <p className="font-semibold text-ink text-sm">Don't chase past returns — consistency beats timing</p>
                  <p className="text-ink/65 text-sm mt-1">A fund that returned 25% last year might return 5% next year. Instead of switching chasing returns, pick a good fund and stay invested. Consistent ₹5,000/month SIP beats trying to time entry with ₹50,000 lumps.</p>
                </div>
              </div>
            </div>

            {/* Which Fund Type Is Right for You */}
            <h2 className="text-2xl font-bold text-ink mb-2">Which Type of Mutual Fund Should You SIP In?</h2>
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-3">
              <div className="p-4 bg-secondary border border-rule rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  <span className="bg-ink text-white text-xs font-bold px-2 py-0.5 rounded">LOW RISK</span>
                  <h3 className="font-bold text-ink">Large Cap Funds</h3>
                </div>
                <p className="text-sm text-ink/80 mb-2">Invest in India's top 100 companies (Reliance, TCS, HDFC Bank etc). Most stable equity category — lower volatility but lower upside vs mid/small cap.</p>
                <div className="text-xs text-ink/65 space-y-1">
              ...
              <div className="p-4 bg-paper border border-rule rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  <span className="bg-ink text-white text-xs font-bold px-2 py-0.5 rounded">MEDIUM RISK</span>
                  <h3 className="font-bold text-ink">Flexi Cap Funds</h3>
                </div>
                <p className="text-sm text-ink/80 mb-2">Fund manager allocates freely across large, mid and small caps based on market conditions. Best balance of growth potential and risk management.</p>
                <div className="text-xs text-ink/65 space-y-1">
              ...
              <div className="p-4 bg-green-50 border border-green-100 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-bold text-ink">ELSS Funds</h3>
                </div>
                <p className="text-sm text-ink/80 mb-2">Equity Linked Saving Scheme — the only mutual fund category with a 3-year lock-in that gives ₹1.5L tax deduction under Section 80C (Section 123 under ITA 2025 in Old Regime). Dual benefit: wealth creation + tax saving.</p>
                <div className="text-xs text-ink/65 space-y-1">
              ...
              <div className="p-4 bg-orange-50 border border-orange-100 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-bold text-ink">Mid & Small Cap Funds</h3>
                </div>
                <p className="text-sm text-ink/80 mb-2">Invest in companies ranked 101–500. Higher growth potential but 30–50% drawdowns are common in bear markets. Only suitable if you won't need the money for 10+ years.</p>
                <div className="text-xs text-ink/65 space-y-1">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-3">
              <a href="https://groww.in" target="_blank" rel="noopener noreferrer" className="block p-4 bg-card border border-rule rounded-lg hover:border-green-400 hover:shadow-md transition-all group">
                <div className="font-bold text-ink mb-1 group-hover:text-green-700">Groww</div>
                <p className="text-xs text-ink/65 mb-3">Beginner-friendly UI. Direct plans only. Largest retail MF platform in India. Great for first-time investors.</p>
                <span className="text-xs bg-green-100 text-green-700 px-2 py-1 rounded font-medium">Start SIP →</span>
              </a>
              <a href="https://zerodha.com/coin" target="_blank" rel="noopener noreferrer" className="block p-4 bg-card border border-rule rounded-lg hover:border-blue-400 hover:shadow-md transition-all group">
                <div className="font-bold text-ink mb-1 group-hover:text-credit">Zerodha Coin</div>
                <p className="text-xs text-ink/65 mb-3">Zero commission direct plans. Linked to Zerodha Demat. Best if you also trade stocks/ETFs alongside SIP.</p>
                <span className="text-xs bg-blue-100 text-ink px-2 py-1 rounded font-medium">Start SIP →</span>
              </a>
              <a href="https://kuvera.in" target="_blank" rel="noopener noreferrer" className="block p-4 bg-card border border-rule rounded-lg hover:border-credit hover:shadow-md transition-all group">
                <div className="font-bold text-ink mb-1 group-hover:text-credit">Kuvera</div>
                <p className="text-xs text-ink/65 mb-3">Fully free direct-plan platform with goal-based investing tools. Ideal for long-term systematic investors.</p>
                <span className="text-xs bg-secondary text-ink px-2 py-1 rounded font-medium">Start SIP →</span>
              </a>
              <a href="https://www.etmoney.com" target="_blank" rel="noopener noreferrer" className="block p-4 bg-card border border-rule rounded-lg hover:border-orange-400 hover:shadow-md transition-all group">
                <div className="font-bold text-ink mb-1 group-hover:text-orange-700">ET Money</div>
                <p className="text-xs text-ink/65 mb-3">Smart fund recommendations, SIP tracker, and insurance in one app. Good for users who want guided investing.</p>
              ...
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-secondary">
                    ...
                    <th className="border border-rule p-3 text-center font-semibold text-ink">SIP</th>
                    <th className="border border-rule p-3 text-center font-semibold text-green-700">Lump Sum</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-rule p-3 text-ink/80">Capital Required</td>
                    <td className="border border-rule p-3 text-center">Small amounts (₹500+/month)</td>
                    <td className="border border-rule p-3 text-center">Large corpus needed upfront</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 text-ink/80">Market Timing Risk</td>
                    <td className="border border-rule p-3 text-center">None — rupee cost averaging eliminates timing</td>
                    <td className="border border-rule p-3 text-center">High — invest peak = lower returns</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 text-ink/80">Returns (10-year bull market)</td>
                    <td className="border border-rule p-3 text-center">8.5% annualized (reduced timing risk)</td>
                    <td className="border border-rule p-3 text-center">12% annualized (invested from start)</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 text-ink/80">Psychological Stress</td>
                    <td className="border border-rule p-3 text-center">Low — regular investing is mechanical</td>
                    <td className="border border-rule p-3 text-center">High — worry about entry price</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 text-ink/80">Discipline Required</td>
                    <td className="border border-rule p-3 text-center">High — automate & stay invested</td>
                    <td className="border border-rule p-3 text-center">Medium — one-time decision</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 text-ink/80">Best For</td>
                    <td className="border border-rule p-3 text-center">Salaried, young investors, no lump sum</td>
                    <td className="border border-rule p-3 text-center">Large inheritance, bonus, market at bottom</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 text-ink/80">Average Success Rate</td>
                    <td className="border border-rule p-3 text-center">80% beat lump sum in 10+ years</td>
                    <td className="border border-rule p-3 text-center">Depends on entry point timing</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            {/* SIP Returns Table */}
            <h2 className="text-2xl font-bold text-ink mb-2">SIP Returns Table — How Much Will ₹1,000/Month Grow? (at 12% p.a.)</h2>
            <p className="text-ink/65 mb-4">
            ...
            <div className="overflow-x-auto mb-3">
              <table className="w-full border-collapse text-sm">
                ...
                <tbody>
                  <tr>
                    <td className="border border-rule p-3 font-semibold text-ink">₹1,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹82,486</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹2.32 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹5.05 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹9.99 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹18.98 L</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 font-semibold text-ink">₹2,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹1.65 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹4.65 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹10.10 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹19.98 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹37.95 L</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 font-semibold text-ink">₹5,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹4.12 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹11.62 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹25.23 L</td>
                    <td className="border border-rule p-3 text-center text-ink font-semibold">₹49.96 L</td>
                    <td className="border border-rule p-3 text-center text-ink font-semibold">₹94.88 L</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 font-semibold text-ink">₹10,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹8.25 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹23.23 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹50.46 L</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹1.00 Cr</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹1.90 Cr</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 font-semibold text-ink">₹20,000/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹16.49 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹46.47 L</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹1.01 Cr</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹1.99 Cr</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹3.79 Cr</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="overflow-x-auto mb-3">
              <table className="w-full border-collapse text-sm">
                <thead>
                  <tr className="bg-ink text-white">
                    <th className="border border-ink p-3 text-left font-semibold">Time Horizon</th>
                    <th className="border border-ink p-3 text-center font-semibold">Monthly SIP Needed</th>
                    <th className="border border-ink p-3 text-center font-semibold">Total Invested</th>
                    <th className="border border-ink p-3 text-center font-semibold">Total Gains</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-rule p-3 font-semibold text-ink">10 Years</td>
                    <td className="border border-rule p-3 text-center text-red-700 font-bold">₹43,041/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹51.65 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹48.35 L</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 font-semibold text-ink">15 Years</td>
                    <td className="border border-rule p-3 text-center text-orange-700 font-bold">₹19,819/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹35.67 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹64.33 L</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 font-semibold text-ink">20 Years</td>
                    <td className="border border-rule p-3 text-center text-ink font-bold">₹10,009/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹24.02 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹75.98 L</td>
                  </tr>
                  <tr className="bg-secondary">
                    <td className="border border-rule p-3 font-semibold text-ink">25 Years</td>
                    <td className="border border-rule p-3 text-center text-green-700 font-bold">₹5,270/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹15.81 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹84.19 L</td>
                  </tr>
                  <tr>
                    <td className="border border-rule p-3 font-semibold text-ink">30 Years</td>
                    <td className="border border-rule p-3 text-center text-ink font-bold">₹2,833/month</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹10.20 L</td>
                    <td className="border border-rule p-3 text-center text-ink/80">₹89.80 L</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="py-12 px-6 bg-secondary">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold text-ink mb-2">Related Investment & Retirement Calculators</h2>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Link href="/calculators/swp">
                <div className="p-4 bg-card rounded-lg border hover:border-credit hover:shadow transition-all">
                  ...
                  <p className="text-sm text-ink/65">Plan systematic withdrawals from your SIP corpus in retirement</p>
                </div>
              </Link>
              <Link href="/calculators/nps">
                <div className="p-4 bg-card rounded-lg border hover:border-credit hover:shadow transition-all">
                  <h3 className="font-semibold text-ink mb-1">NPS Calculator</h3>
                  <p className="text-sm text-ink/65">Calculate NPS corpus, pension and ₹50,000 extra tax saving</p>
                </div>
              </Link>
              <Link href="/calculators/income-tax">
                <div className="p-4 bg-card rounded-lg border hover:border-credit hover:shadow transition-all">
                  <h3 className="font-semibold text-ink mb-1">Income Tax Calculator</h3>
                  <p className="text-sm text-ink/65">Calculate tax on SIP capital gains under LTCG rules</p>
                </div>
              </Link>
              <Link href="/calculators">
                <div className="p-4 bg-secondary rounded-lg border border-rule hover:shadow transition-all">
                  ...
                  <p className="text-sm text-credit">View complete suite of financial tools</p>
                </div>
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-4 pb-10">
          <LeadCaptureForm source="SIP Calculator" />
          <FindCABanner context="planning your SIP investments" />
        </div>
      </div>
    </>
  );
