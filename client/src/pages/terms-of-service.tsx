      ...
      <div>
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">3. Financial &amp; Tax Disclaimer</h2>

              <h3 className="text-xl font-medium text-slate-800 mb-3">3.1 No Professional Advice</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-xl font-medium text-slate-800 mb-3">3.2 Calculator Accuracy</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-xl font-medium text-slate-800 mb-3">3.3 Limitation of Liability</h3>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">4. CA Directory — Terms &amp; Disclaimer</h2>
              ...
              <h3 className="text-xl font-medium text-slate-800 mb-3">4.1 For Users Searching for a CA</h3>
              <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-1">
                ...
                <li>Always verify a CA's ICAI membership number at <a href="https://www.icai.org" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">icai.org</a> before engaging their services</li>
              ...
              <h3 className="text-xl font-medium text-slate-800 mb-3">4.2 For CAs Registering a Profile</h3>
              <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-1">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-medium text-slate-800 mb-3">You agree to:</h3>
              <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-1">
              ...
              <h3 className="text-xl font-medium text-slate-800 mb-3">You agree not to:</h3>
              <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-1">
            ...
            {/* 7. Privacy */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">7. Privacy &amp; Data Protection</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-slate-700 mb-4">AiTaxBot integrates with third-party services including:</p>
              <ul className="list-disc pl-6 mb-4 text-slate-700 space-y-1">
            ...
            {/* 11. Modifications */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">11. Modifications to Terms</h2>
              <p className="text-slate-700">
            ...
            {/* 12. Governing Law */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">12. Governing Law &amp; Jurisdiction</h2>
              <p className="text-slate-700">
            ...
            <section className="mb-8">
              ...
              <div className="bg-slate-50 rounded-lg p-6">
                ...
                <p className="text-slate-500 text-sm mt-3">We respond to queries within 48 hours on business days.</p>
              </div>
            </section>
