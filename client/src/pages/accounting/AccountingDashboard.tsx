    ...
    return (
      <div className="container mx-auto p-6">
        <div className="max-w-2xl mx-auto mt-16">
          <Card className="border-2 border-rule">
            <CardHeader className="text-center pb-4">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Lock className="h-8 w-8 text-credit" />
              </div>
            ...
            <CardContent className="text-center pb-8">
              <div className="mb-6">
                <h3 className="font-semibold text-lg mb-3 text-ink">Features you'll get access to:</h3>
                <ul className="text-left space-y-2 mb-6 max-w-md mx-auto">
                  <li className="flex items-start">
                    ...
                    <span className="text-ink/80">Multi-firm management with GST/Non-GST support</span>
                  </li>
                  <li className="flex items-start">
                    <Users className="h-5 w-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-ink/80">Client management with complete contact details</span>
                  </li>
                  <li className="flex items-start">
                    <FileText className="h-5 w-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-ink/80">GST-compliant invoice generation with auto-calculations</span>
                  </li>
                  <li className="flex items-start">
                    <BookOpen className="h-5 w-5 text-green-600 mr-2 mt-0.5 flex-shrink-0" />
                    <span className="text-ink/80">Sales register and GST reports</span>
                  </li>
                </ul>
              </div>
              <Button 
                size="lg" 
                className="bg-ink hover:bg-credit text-white"
