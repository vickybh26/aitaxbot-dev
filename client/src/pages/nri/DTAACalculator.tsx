    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 md:py-16 border-t border-slate-200 bg-slate-50">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <p className="text-slate-600 mb-8">Enter your details to see how much tax you can save under DTAA</p>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  />
                  <p className="text-xs text-slate-500 mt-1">₹{annualIncome.toLocaleString("en-IN")}</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  />
                  <p className="text-xs text-slate-500 mt-1">Default: {tdsPratesByType[incomeType as keyof typeof tdsPratesByType]}% for {incomeType.replace("-", " ")}</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  />
                  <p className="text-xs text-slate-500 mt-1">Marginal tax rate in your country</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-white rounded-lg shadow-md p-6">
                    <p className="text-slate-600 text-sm mb-2">TDS Deducted in India</p>
                    <p className="text-3xl font-bold text-slate-900">₹{tdsDeducted.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-white rounded-lg shadow-md p-6">
                    <p className="text-slate-600 text-sm mb-2">Tax Liability in {countryInfo.name}</p>
                    <p className="text-3xl font-bold text-slate-900">₹{foreignTaxLiability.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-white rounded-lg shadow-md p-6">
                    <p className="text-slate-600 text-sm mb-2">DTAA Relief Available (FTC)</p>
                    <p className="text-3xl font-bold text-blue-600">₹{dtaaRelief.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-white rounded-lg shadow-md p-6">
                    <p className="text-slate-600 text-sm mb-2">Net Tax in {countryInfo.name}</p>
                    <p className="text-3xl font-bold text-slate-900">₹{netForeignTax.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-white rounded-lg shadow-md p-6">
                    <p className="text-slate-600 text-sm mb-2">Total Effective Tax</p>
                    <p className="text-3xl font-bold text-slate-900">₹{totalTax.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-green-50 rounded-lg shadow-md p-6 border border-green-200">
                    <p className="text-slate-600 text-sm mb-2">Tax Saved via DTAA</p>
      ...
      <section className="py-12 md:py-16 border-t border-slate-200 bg-slate-50">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="bg-blue-50 rounded-lg border border-blue-100 p-8">
            <p className="text-slate-700 mb-6">DTAAs use two main methods to eliminate double taxation:</p>
            ...
            <table className="w-full border border-slate-300 rounded-lg overflow-hidden">
              ...
              <tbody>
                <tr className="border-b border-slate-300 hover:bg-slate-50">
                  <td className="px-6 py-4 font-semibold text-slate-900">USA</td>
                  <td className="px-6 py-4 text-slate-700">1990</td>
                  <td className="px-6 py-4 text-slate-700">FTC on all income</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                </tr>
                <tr className="border-b border-slate-300 hover:bg-slate-50">
                  <td className="px-6 py-4 font-semibold text-slate-900">UK</td>
                  <td className="px-6 py-4 text-slate-700">1993</td>
                  <td className="px-6 py-4 text-slate-700">FTC + reduced rates</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                </tr>
                <tr className="border-b border-slate-300 hover:bg-slate-50 bg-yellow-50">
                  <td className="px-6 py-4 font-semibold text-slate-900">UAE</td>
                  <td className="px-6 py-4 text-slate-700">No DTAA</td>
                  <td className="px-6 py-4 text-slate-700">TDS is final cost</td>
                  <td className="px-6 py-4 text-slate-700">12.5%</td>
                  <td className="px-6 py-4 text-slate-700">N/A</td>
                </tr>
                <tr className="border-b border-slate-300 hover:bg-slate-50">
                  <td className="px-6 py-4 font-semibold text-slate-900">Canada</td>
                  <td className="px-6 py-4 text-slate-700">1996</td>
                  <td className="px-6 py-4 text-slate-700">FTC on all income</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                </tr>
                <tr className="border-b border-slate-300 hover:bg-slate-50">
                  <td className="px-6 py-4 font-semibold text-slate-900">Australia</td>
                  <td className="px-6 py-4 text-slate-700">1991</td>
                  <td className="px-6 py-4 text-slate-700">FTC on all income</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                </tr>
                <tr className="border-b border-slate-300 hover:bg-slate-50">
                  <td className="px-6 py-4 font-semibold text-slate-900">Singapore</td>
                  <td className="px-6 py-4 text-slate-700">1994</td>
                  <td className="px-6 py-4 text-slate-700">Reduced rates</td>
                  <td className="px-6 py-4 text-slate-700">15%</td>
                  <td className="px-6 py-4 text-slate-700">10%</td>
                </tr>
                <tr className="hover:bg-slate-50">
                  <td className="px-6 py-4 font-semibold text-slate-900">Germany</td>
                  <td className="px-6 py-4 text-slate-700">1996</td>
                  <td className="px-6 py-4 text-slate-700">FTC + exemptions</td>
                  <td className="px-6 py-4 text-slate-700">10%</td>
                  <td className="px-6 py-4 text-slate-700">10%</td>
                </tr>
              </tbody>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 border-l-4 border-orange-500">
              <h3 className="text-xl font-bold mb-6 text-slate-900">Example 1: US-Based NRI with NRO Interest</h3>

              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <span className="text-slate-700">NRO FD Interest</span>
                  <span className="font-semibold text-slate-900">₹5,00,000</span>
                </div>
                <div className="flex justify-between bg-blue-50 p-2 rounded">
                  <span className="text-slate-700">TDS in India at 30%</span>
                  <span className="font-semibold text-slate-900">₹1,50,000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-700">US Tax Rate</span>
                  <span className="font-semibold text-slate-900">22%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-700">US Tax on Same Income</span>
                  <span className="font-semibold text-slate-900">₹1,10,000</span>
                </div>

                <div className="border-t border-slate-200 pt-4 mt-4">
                  <p className="text-slate-700 mb-3"><strong>DTAA Calculation (FTC Method):</strong></p>
                  <div className="space-y-2 bg-green-50 p-3 rounded">
                    <div className="flex justify-between">
                      <span className="text-slate-700">Credit Available (Min of India TDS &amp; US tax)</span>
                      <span className="font-semibold text-green-700">₹1,10,000</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-700">Additional US Tax</span>
                      <span className="font-semibold text-green-700">₹0</span>
                    </div>
                    <div className="flex justify-between border-t border-green-200 pt-2 mt-2">
                      <span className="text-slate-900 font-bold">Total Tax Paid</span>
            ...
            {/* Example 2 */}
            <div className="bg-white rounded-lg shadow-md p-8 border-l-4 border-orange-500">
              <h3 className="text-xl font-bold mb-6 text-slate-900">Example 2: UK-Based NRI with Rental Income</h3>

              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <span className="text-slate-700">Indian Rental Income</span>
                ...
                <div className="flex justify-between">
                  <span className="text-slate-700">UK Tax Rate</span>
                  <span className="font-semibold text-slate-900">40%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-700">UK Tax Liability</span>
                  <span className="font-semibold text-slate-900">₹3,20,000</span>
                </div>
                ...
                <div className="border-t border-slate-200 pt-4 mt-4">
                  ...
                  <div className="space-y-2 bg-green-50 p-3 rounded">
                    <div className="flex justify-between">
                      <span className="text-slate-700">Credit for India TDS</span>
                      <span className="font-semibold text-green-700">₹2,40,000</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-700">Net UK Tax Payable</span>
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link href="/nri/nro-nre-comparison">
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer border border-slate-200">
                <Globe size={32} className="text-orange-600 mb-4" />
                <h3 className="font-bold text-slate-900 mb-2">NRO vs NRE Comparison</h3>
                <p className="text-sm text-slate-600">Understand the difference between NRO and NRE accounts and choose the right one.</p>
              </div>
            </Link>
            ...
            <Link href="/nri/income-tax-calculator">
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer border border-slate-200">
                ...
                <h3 className="font-bold text-slate-900 mb-2">NRI Income Tax Calculator</h3>
                <p className="text-sm text-slate-600">Calculate your income tax liability as an NRI on various income sources.</p>
              </div>
            </Link>
            ...
            <Link href="/nri/repatriation-planner">
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer border border-slate-200">
                ...
                <h3 className="font-bold text-slate-900 mb-2">Repatriation Planner</h3>
                <p className="text-sm text-slate-600">Plan your fund remittance strategy with tax-efficient repatriation options.</p>
              </div>
            </Link>
            ...
            <Link href="/calculators/income-tax">
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer border border-slate-200">
                ...
                <h3 className="font-bold text-slate-900 mb-2">Income Tax Calculator</h3>
                <p className="text-sm text-slate-600">Calculate your tax liability under the old and new tax regimes.</p>
              </div>
            </Link>
          </div>
        </div>
