...
export default function DTAACalculator() {
  ...
  return (
    <div className="min-h-screen bg-card">
      ...
      <section className="py-12 md:py-16 border-t border-rule bg-secondary">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold mb-2">Calculate Your DTAA Relief</h2>
          <p className="text-ink/65 mb-8">Enter your details to see how much tax you can save under DTAA</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="space-y-4">
                {/* UAE Special Note */}
                {isUAE && (
                  <div className="bg-secondary border border-rule rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-card rounded-lg shadow-md p-6">
                    <p className="text-ink/65 text-sm mb-2">TDS Deducted in India</p>
                    <p className="text-3xl font-bold text-ink">₹{tdsDeducted.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-card rounded-lg shadow-md p-6">
                    <p className="text-ink/65 text-sm mb-2">Tax Liability in {countryInfo.name}</p>
                    <p className="text-3xl font-bold text-ink">₹{foreignTaxLiability.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-card rounded-lg shadow-md p-6">
                    <p className="text-ink/65 text-sm mb-2">DTAA Relief Available (FTC)</p>
                    <p className="text-3xl font-bold text-credit">₹{dtaaRelief.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-card rounded-lg shadow-md p-6">
                    <p className="text-ink/65 text-sm mb-2">Net Tax in {countryInfo.name}</p>
                    <p className="text-3xl font-bold text-ink">₹{netForeignTax.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-card rounded-lg shadow-md p-6">
                    <p className="text-ink/65 text-sm mb-2">Total Effective Tax</p>
                    <p className="text-3xl font-bold text-ink">₹{totalTax.toLocaleString("en-IN", { maximumFractionDigits: 0 })}</p>
                  </div>

                  <div className="bg-green-50 rounded-lg shadow-md p-6 border border-green-200">
                    <p className="text-ink/65 text-sm mb-2">Tax Saved via DTAA</p>
      ...
      <section className="py-12 md:py-16 border-t border-rule">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* What is DTAA */}
            <div className="bg-secondary rounded-lg p-8 border border-rule">
              <h3 className="text-xl font-bold text-ink mb-4">What is DTAA?</h3>
              <p className="text-ink/80 leading-relaxed">
      ...
      <section className="py-12 md:py-16 border-t border-rule bg-secondary">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="bg-secondary rounded-lg border border-rule p-8">
            <p className="text-ink/80 mb-6">DTAAs use two main methods to eliminate double taxation:</p>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold text-ink mb-2">1. Exemption Method</h3>
              ...
              <div>
                <h3 className="text-lg font-bold text-ink mb-2">2. Tax Credit Method (Most Common)</h3>
                <p className="text-ink/80">
      ...
      <section className="py-12 md:py-16 border-t border-rule">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border border-rule rounded-lg overflow-hidden">
              ...
              <tbody>
                <tr className="border-b border-rule hover:bg-secondary">
                  <td className="px-6 py-4 font-semibold text-ink">USA</td>
                  <td className="px-6 py-4 text-ink/80">1990</td>
                  <td className="px-6 py-4 text-ink/80">FTC on all income</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                </tr>
                <tr className="border-b border-rule hover:bg-secondary">
                  <td className="px-6 py-4 font-semibold text-ink">UK</td>
                  <td className="px-6 py-4 text-ink/80">1993</td>
                  <td className="px-6 py-4 text-ink/80">FTC + reduced rates</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                </tr>
                <tr className="border-b border-rule hover:bg-secondary bg-yellow-50">
                  <td className="px-6 py-4 font-semibold text-ink">UAE</td>
                  <td className="px-6 py-4 text-ink/80">No DTAA</td>
                  <td className="px-6 py-4 text-ink/80">TDS is final cost</td>
                  <td className="px-6 py-4 text-ink/80">12.5%</td>
                  <td className="px-6 py-4 text-ink/80">N/A</td>
                </tr>
                <tr className="border-b border-rule hover:bg-secondary">
                  <td className="px-6 py-4 font-semibold text-ink">Canada</td>
                  <td className="px-6 py-4 text-ink/80">1996</td>
                  <td className="px-6 py-4 text-ink/80">FTC on all income</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                </tr>
                <tr className="border-b border-rule hover:bg-secondary">
                  <td className="px-6 py-4 font-semibold text-ink">Australia</td>
                  <td className="px-6 py-4 text-ink/80">1991</td>
                  <td className="px-6 py-4 text-ink/80">FTC on all income</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                </tr>
                <tr className="border-b border-rule hover:bg-secondary">
                  <td className="px-6 py-4 font-semibold text-ink">Singapore</td>
                  <td className="px-6 py-4 text-ink/80">1994</td>
                  <td className="px-6 py-4 text-ink/80">Reduced rates</td>
                  <td className="px-6 py-4 text-ink/80">15%</td>
                  <td className="px-6 py-4 text-ink/80">10%</td>
                </tr>
                <tr className="hover:bg-secondary">
                  <td className="px-6 py-4 font-semibold text-ink">Germany</td>
                  <td className="px-6 py-4 text-ink/80">1996</td>
                  <td className="px-6 py-4 text-ink/80">FTC + exemptions</td>
                  <td className="px-6 py-4 text-ink/80">10%</td>
                  <td className="px-6 py-4 text-ink/80">10%</td>
                </tr>
              </tbody>
      ...
      <section className="py-12 md:py-16 border-t border-rule bg-secondary">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Example 1 */}
            <div className="bg-card rounded-lg shadow-md p-8 border-l-4 border-orange-500">
              <h3 className="text-xl font-bold mb-6 text-ink">Example 1: US-Based NRI with NRO Interest</h3>

              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <span className="text-ink/80">NRO FD Interest</span>
                  <span className="font-semibold text-ink">₹5,00,000</span>
                </div>
                <div className="flex justify-between bg-secondary p-2 rounded">
                  <span className="text-ink/80">TDS in India at 30%</span>
                  <span className="font-semibold text-ink">₹1,50,000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-ink/80">US Tax Rate</span>
                  <span className="font-semibold text-ink">22%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-ink/80">US Tax on Same Income</span>
                  <span className="font-semibold text-ink">₹1,10,000</span>
                </div>

                <div className="border-t border-rule pt-4 mt-4">
                  <p className="text-ink/80 mb-3"><strong>DTAA Calculation (FTC Method):</strong></p>
                  <div className="space-y-2 bg-green-50 p-3 rounded">
                    <div className="flex justify-between">
                      <span className="text-ink/80">Credit Available (Min of India TDS &amp; US tax)</span>
                      <span className="font-semibold text-green-700">₹1,10,000</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-ink/80">Additional US Tax</span>
                      <span className="font-semibold text-green-700">₹0</span>
                    </div>
                    <div className="flex justify-between border-t border-green-200 pt-2 mt-2">
                      <span className="text-ink font-bold">Total Tax Paid</span>
            ...
            {/* Example 2 */}
            <div className="bg-card rounded-lg shadow-md p-8 border-l-4 border-orange-500">
              <h3 className="text-xl font-bold mb-6 text-ink">Example 2: UK-Based NRI with Rental Income</h3>

              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <span className="text-ink/80">Indian Rental Income</span>
                  <span className="font-semibold text-ink">₹8,00,000</span>
                </div>
                <div className="flex justify-between bg-secondary p-2 rounded">
                  <span className="text-ink/80">TDS in India at 30%</span>
                  <span className="font-semibold text-ink">₹2,40,000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-ink/80">UK Tax Rate</span>
                  <span className="font-semibold text-ink">40%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-ink/80">UK Tax Liability</span>
                  <span className="font-semibold text-ink">₹3,20,000</span>
                </div>
                ...
                <div className="border-t border-rule pt-4 mt-4">
                  ...
                  <div className="space-y-2 bg-green-50 p-3 rounded">
                    <div className="flex justify-between">
                      <span className="text-ink/80">Credit for India TDS</span>
                      <span className="font-semibold text-green-700">₹2,40,000</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-ink/80">Net UK Tax Payable</span>
      ...
      <section className="py-12 md:py-16 border-t border-rule bg-secondary">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="space-y-4">
            {/* FAQ 1 */}
            <details className="bg-card rounded-lg border border-rule p-6 group">
        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link href="/nri/nro-nre-comparison">
              <div className="bg-card rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer border border-rule">
                <Globe size={32} className="text-orange-600 mb-4" />
                <h3 className="font-bold text-ink mb-2">NRO vs NRE Comparison</h3>
                <p className="text-sm text-ink/65">Understand the difference between NRO and NRE accounts and choose the right one.</p>
              </div>
            </Link>
            ...
            <Link href="/nri/income-tax-calculator">
              <div className="bg-card rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer border border-rule">
                ...
                <h3 className="font-bold text-ink mb-2">NRI Income Tax Calculator</h3>
                <p className="text-sm text-ink/65">Calculate your income tax liability as an NRI on various income sources.</p>
              </div>
            </Link>
            ...
            <Link href="/nri/repatriation-planner">
              <div className="bg-card rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer border border-rule">
                ...
                <h3 className="font-bold text-ink mb-2">Repatriation Planner</h3>
                <p className="text-sm text-ink/65">Plan your fund remittance strategy with tax-efficient repatriation options.</p>
              </div>
            </Link>
            ...
            <Link href="/calculators/income-tax">
              <div className="bg-card rounded-lg shadow-md p-6 hover:shadow-lg transition cursor-pointer border border-rule">
                ...
                <h3 className="font-bold text-ink mb-2">Income Tax Calculator</h3>
                <p className="text-sm text-ink/65">Calculate your tax liability under the old and new tax regimes.</p>
              </div>
            </Link>
          </div>
        </div>
