          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-md p-8 border-l-4 border-blue-500">
              ...
              <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-600 mt-4">
                <p className="text-sm font-semibold text-blue-700 uppercase mb-1">Repatriation</p>
                <p className="text-sm text-blue-700">Can repatriate NRO balance up to USD 1 million/year with Form 15CA/15CB + CA certificate</p>
              </div>
            </div>
          </div>
        </div>
