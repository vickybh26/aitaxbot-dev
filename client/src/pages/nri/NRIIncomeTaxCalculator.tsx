      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">Interactive NRI Income Tax Calculator</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <label className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <span className="text-gray-700 font-medium">Salary from Indian employer</span>
                  ...
                  <label className="flex items-start gap-3">
                    ...
                    />
                    <div className="flex-1">
                      <span className="text-gray-700 font-medium">Rental income from Indian property</span>
                  ...
                  <label className="flex items-start gap-3">
                    ...
                    />
                    <div className="flex-1">
                      <span className="text-gray-700 font-medium">NRO account interest (₹) — auto-applies 30% TDS</span>
                  ...
                  <label className="flex items-start gap-3">
                    ...
                    />
                    <div className="flex-1">
                      <span className="text-gray-700 font-medium">Dividend income (₹) — auto-applies 20% TDS</span>
                  ...
                  <label className="flex items-start gap-3">
                    ...
                    />
                    <div className="flex-1">
                      <span className="text-gray-700 font-medium">Short-term capital gains - equity (₹) — 20% flat (post budget 2024)</span>
                  ...
                  <label className="flex items-start gap-3">
                    ...
                    />
                    <div className="flex-1">
                      <span className="text-gray-700 font-medium">Long-term capital gains - equity (₹) — 12.5% flat above ₹1.25L (post budget 2024)</span>
                  ...
                  <label className="flex items-start gap-3">
                    ...
                    />
                    <div className="flex-1">
                      <span className="text-gray-700 font-medium">Long-term capital gains - property (₹)</span>
              ...
              <div>
                <label className="flex items-center gap-3 mb-3">
                  <input
                    ...
                    className="w-4 h-4 text-rose-600"
                  />
                  <span className="text-gray-700 font-medium">Enable DTAA Benefit</span>
                </label>
                {dtaaEnabled && (
                  <div className="space-y-3 ml-7">
                    <div>
                      <label className="block text-sm text-gray-600 mb-1">TDS already paid (₹)</label>
                      <input
                        type="number"
                        value={tdsPaid}
                    ...
                    <div>
                      <label className="block text-sm text-gray-600 mb-1">DTAA relief rate (%)</label>
                      <input
                        type="number"
                        value={dtaaRate}
              ...
              {/* Deductions */}
              <div>
                <h3 className="text-sm font-semibold text-gray-700 mb-3">Deductions (Only in Old Regime)</h3>
                <div className="space-y-3">
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Section 80C (Max ₹1.5L)</label>
                    <input
                      type="number"
                      value={section80c}
                      ...
                      placeholder="₹0"
                      disabled={regime === "new"}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-500 disabled:bg-gray-100"
                    />
                  </div>
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Section 80D health insurance (Max ₹25K/50K)</label>
                    <input
                      type="number"
                      value={section80d}
                  ...
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Home loan interest 80EEA (₹)</label>
                    <input
                      type="number"
            ...
            <div className="bg-gradient-to-br from-rose-50 to-orange-50 rounded-lg p-6 space-y-4 h-fit">
              <h3 className="text-lg font-bold text-gray-900 mb-6">Tax Calculation Summary</h3>

              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-rose-200">
                  <span className="text-gray-700">Total Indian Income</span>
                ...
                <div className="pt-2 mt-4 space-y-2 bg-white bg-opacity-50 p-4 rounded-lg">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Tax on Salary &amp; Rental</span>
                    <span className="font-medium text-gray-800">{formatCurrency(taxOnSalaryAndRental)}</span>
                  </div>

                  {incomeToggles.nroInterest && (
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Tax on NRO Interest (30%)</span>
                      <span className="font-medium text-gray-800">{formatCurrency(nroInterestTax)}</span>
                    </div>
                  )}

                  {incomeToggles.dividend && (
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Tax on Dividend (20%)</span>
                      <span className="font-medium text-gray-800">{formatCurrency(dividendTax)}</span>
                    </div>
                  )}

                  {incomeToggles.stcgEquity && (
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Tax on STCG Equity (20%)</span>
                      <span className="font-medium text-gray-800">{formatCurrency(stcgEquityTax)}</span>
                    </div>
                  )}

                  {incomeToggles.ltcgEquity && (
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Tax on LTCG Equity (12.5%)</span>
                      <span className="font-medium text-gray-800">{formatCurrency(ltcgEquityTax)}</span>
                    </div>
                  )}

                  {incomeToggles.ltcgProperty && (
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-600">Tax on LTCG Property (12.5%)</span>
                      <span className="font-medium text-gray-800">{formatCurrency(ltcgPropertyTax)}</span>
                    </div>
                  )}
                </div>

                <div className="flex justify-between items-center py-2 border-b border-rose-200">
                  <span className="text-gray-700">Subtotal (before surcharge &amp; cess)</span>
                  <span className="font-semibold text-gray-900">{formatCurrency(totalTaxBeforeSurcharge)}</span>
                </div>

                {surcharge > 0 && (
                  <div className="flex justify-between items-center py-2 border-b border-rose-200">
                    <span className="text-gray-700">Surcharge (25%)</span>
                    <span className="font-semibold text-gray-900">{formatCurrency(surcharge)}</span>
                  </div>
                )}

                <div className="flex justify-between items-center py-2 border-b border-rose-200">
                  <span className="text-gray-700">Health &amp; Education Cess (4%)</span>
                  <span className="font-semibold text-gray-900">{formatCurrency(cess)}</span>
                </div>

                <div className="flex justify-between items-center py-3 bg-white bg-opacity-70 px-3 rounded-lg border-2 border-rose-300">
                  <span className="text-gray-900 font-bold">Total Tax Liability</span>
                  <span className="font-bold text-rose-700 text-lg">{formatCurrency(totalTaxLiability)}</span>
                </div>

                <div className="flex justify-between items-center py-2 border-b border-rose-200">
                  <span className="text-gray-700">TDS Already Deducted</span>
                  <span className="font-semibold text-gray-900">{formatCurrency(totalTdsDeducted)}</span>
                </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12 overflow-x-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">NRI vs Resident Tax Comparison</h2>
          <table className="w-full">
            <thead>
              <tr className="bg-gray-100 border-b-2 border-gray-300">
                <th className="px-4 py-3 text-left font-semibold text-gray-900">Feature</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-900">Resident Indian</th>
                <th className="px-4 py-3 text-left font-semibold text-gray-900">NRI</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="px-4 py-3 text-gray-700">Section 87A Rebate (up to ₹12L)</td>
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="px-4 py-3 text-gray-700">Basic Exemption Limit</td>
                <td className="px-4 py-3">₹3,00,000</td>
                <td className="px-4 py-3">₹3,00,000</td>
              </tr>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="px-4 py-3 text-gray-700">NRO Interest TDS</td>
                <td className="px-4 py-3">N/A</td>
                <td className="px-4 py-3">30% (flat, no threshold)</td>
              </tr>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="px-4 py-3 text-gray-700">LTCG on Equity</td>
                <td className="px-4 py-3">12.5% above ₹1.25L</td>
                <td className="px-4 py-3">12.5% (no ₹1.25L exemption for NRIs in some cases)</td>
              </tr>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="px-4 py-3 text-gray-700">Old Regime Deductions (80C, 80D)</td>
                <td className="px-4 py-3">
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="px-4 py-3 text-gray-700">NPS 80CCD(1B) deduction</td>
                <td className="px-4 py-3">
                  <span className="text-green-600 font-semibold">✓ Available</span>
                </td>
                <td className="px-4 py-3">
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="px-4 py-3 text-gray-700">DTAA Benefits</td>
                <td className="px-4 py-3">
              ...
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="px-4 py-3 text-gray-700">Advance Tax</td>
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <details key={index} className="group border border-gray-200 rounded-lg">
                <summary className="flex items-center justify-between cursor-pointer p-4 bg-gray-50 hover:bg-gray-100 transition">
                  <h3 className="font-semibold text-gray-900">{faq.q}</h3>
                  <ChevronRight size={20} className="text-gray-600 group-open:rotate-90 transition" />
                </summary>
                <div className="px-4 py-3 text-gray-700 border-t border-gray-200">{faq.a}</div>
              </details>
            ))}
          </div>
        </div>
        ...
        {/* Related Tools */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Related Tools &amp; Calculators</h2>
