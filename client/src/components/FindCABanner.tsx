...
export default function FindCABanner({ context = "filing your ITR" }: Props) {
  return (
    <div className="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
