...
export default function FindCABanner({ context = "filing your ITR" }: Props) {
  return (
    <div className="mt-8 bg-gradient-to-r from-blue-50 to-paper border border-rule rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
      ...
      <a
        href="/find-ca"
        className="flex-shrink-0 inline-flex items-center gap-1.5 bg-ink hover:bg-credit text-white text-sm font-medium px-4 py-2 rounded-xl transition-colors"
      >
        Find a CA
