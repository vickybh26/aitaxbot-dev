          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                enableInflation ? 'bg-persian-blue-600' : 'bg-gray-300'
              }`}
      ...
      <div className="space-y-4">
        <Card className="bg-gray-50 p-5">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-gray-900">Withdrawal Plan Summary</h3>
          ...
          {result && (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                {result.inflationAdjusted && (
                  <Card className="bg-white p-4">
                    <div className="text-xs text-gray-500">Final Withdrawal/mo</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Card className="bg-white p-4">
                  <div className="text-xs text-gray-500">Remaining Corpus</div>
                  <div className="text-base font-bold text-gray-600" data-testid="text-remaining-corpus">
        ...
        {result?.inflationAdjusted && result.yearlySnapshots.length > 1 && (
          <Card className="p-4">
            <h4 className="text-sm font-semibold text-gray-700 mb-3">Year-by-Year Withdrawal (Inflation @ {inflationRate}%)</h4>
